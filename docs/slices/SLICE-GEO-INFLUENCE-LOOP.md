...
|---|---|---|---|---|---|
| **GIL-01** | Per-prompt citation ledger | Per-prompt record: brandMentioned vs brandCited vs absent vs unanswered + per-prompt cited competitor sources. Pure derivation, no store. | — | prompt universe, `measureGeo`, `GeoResult` | **Design** |
